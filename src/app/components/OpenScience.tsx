                          ...
                          >
                            <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
                              <div className="flex gap-3 sm:gap-5">
                                <div className="brand-gold-fill flex h-9 w-9 shrink-0 items-center justify-center rounded-xl font-mono text-xs font-bold text-[#00458b] sm:h-11 sm:w-11 sm:text-sm">
                                  {publicationIndex + 1}
                                </div>
